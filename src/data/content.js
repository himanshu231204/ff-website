const content = {
  ...
  leaderboard: {
    ...
    scoring: {
      ...
      winPoints: '+2 Points',
      kr: 'KR',
      krDescription: 'Kills / Matches',
      final: 'Final',
      finalDescription: 'Points + KR',
    },
    table: {
      rank: 'Rank',
      player: 'Player',
  ...
  rules: {
    ...
    sections: {
      ...
      scoring: {
        ...
        rules: [
          'Win = 2 Points',
          'Kill = Counted for Kill Rate (KR)',
          'KR = Total Kills / Matches Played',
          'Final Score = Points + KR',
        ],
        note: 'Players are sorted by Final Score, then KR, then Wins',
      },
      qualification: {
